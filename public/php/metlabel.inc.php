...
function metlabel_foot(){
	global $met_footright,$wap_footertext,$met_footstat,$met_footaddress,$met_foottel,$met_footother,$met_foottext,$_M;
	...
	if($wap_footertext<>"")$metinfo.="<p>".$wap_footertext."</p>\n";
	//接口代码
